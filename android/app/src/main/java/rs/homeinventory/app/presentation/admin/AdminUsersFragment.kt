...
// SCR-12 — sadrzaj dolazi u tiketu 25.
@AndroidEntryPoint
class AdminUsersFragment : Fragment(R.layout.fragment_placeholder) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textPlaceholderTitle.setText(R.string.nav_admin_users)
    }
