...
// SCR-11 — sadrzaj dolazi u tiketu 25.
@AndroidEntryPoint
class AdminDashboardFragment : Fragment(R.layout.fragment_placeholder) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textPlaceholderTitle.setText(R.string.nav_admin_dashboard)
    }
