...
| 17 | Upravljanje lokacijama | 4 | [x] | 2026-08-31 | | ručno provereno na emulatoru (Pixel6_API36): lista sa brojem predmeta po lokaciji (FR-049), dodavanje sa validacijom (prazan naziv), VR-19 duplikat naziva (409 sa servera prikazan kao poruka), izmena naziva/opisa odmah vidljiva u listi, BR-014 blokirano brisanje sa tačnim brojem predmeta (Garaža, 7 predmeta), brisanje prazne lokacije uz potvrdu i trenutni nestanak iz liste, padajuća lista u formi predmeta odmah odražava trenutne lokacije |
